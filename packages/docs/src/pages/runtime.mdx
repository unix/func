...
import FlowDiagram from '@/components/diagrams/flow-diagram.astro'
...
A system error always indicates a framework declaration or registration defect and is rethrown. Runtime errors may reach local or global handling. Runtime-print errors also carry func's default stderr output. See [Error Handling](/error-handler) for the complete levels and print controls.
