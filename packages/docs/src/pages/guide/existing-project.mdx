...
npm init func
# Enter "admin-cli" at the project-name prompt
...
The creator accepts a plain directory name interactively. Enter the parent directory first, then create the CLI package inside it:
