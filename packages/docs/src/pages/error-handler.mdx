...
<DocsLayout frontmatter={frontmatter} page="error-handler">
...
When funcgo prints an `F_SYSTEM_*` tracking link, open its code-specific reproduction and fix in the [error index](/errors).
