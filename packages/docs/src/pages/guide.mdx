...
export const createCommands = {
  npm: 'npm init func',
  yarn: 'yarn create func',
  pnpm: 'pnpm create func',
  bun: 'bun create func',
}
...
The creator asks for a project name, creates a new directory, and copies the TypeScript template into it. It will not overwrite an existing directory. If you use an agent to create it automatically, follow the [agent setup guide](/guide/agent-setup).
